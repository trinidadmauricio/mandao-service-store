...
version: 1.0.0
type: agent
invocation: "@nextjs-developer" or "nextjs-developer" or "nextjs" or "next"
---

# Next.js Developer Agent

**INVOCACIÓN:** Menciona `@nextjs-developer`, `nextjs-developer`, `nextjs`, `next-dev` o `next` en el chat para activar este agente.
