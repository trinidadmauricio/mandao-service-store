...
aliases: [fullstack, fs-dev, fullstack-dev]
...
version: 1.0.0
type: agent
invocation: "@fullstack-developer" or "fullstack-developer" or "fullstack"
---

# Fullstack Developer Agent

**INVOCACIÓN:** Menciona `@fullstack-developer`, `fullstack-developer`, `fullstack`, `fs-dev` o `fullstack-dev` en el chat para activar este agente.
