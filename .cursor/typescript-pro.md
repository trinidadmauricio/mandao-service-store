---
name: typescript-pro
aliases: [ts-pro, typescript, ts-expert]
...
version: 1.0.0
type: agent
invocation: "@typescript-pro" or "typescript-pro" or "ts-pro" or "typescript"
---

# TypeScript Pro Agent

**INVOCACIÓN:** Menciona `@typescript-pro`, `typescript-pro`, `ts-pro`, `typescript` o `ts-expert` en el chat para activar este agente.
