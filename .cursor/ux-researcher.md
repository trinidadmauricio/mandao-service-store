---
name: ux-researcher
aliases: [ux, ux-research, researcher]
...
version: 1.0.0
type: agent
invocation: "@ux-researcher" or "ux-researcher" or "ux" or "researcher"
---

# UX Researcher Agent

**INVOCACIÓN:** Menciona `@ux-researcher`, `ux-researcher`, `ux`, `ux-research` o `researcher` en el chat para activar este agente.
